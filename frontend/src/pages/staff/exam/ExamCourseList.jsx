...
const ExamCourseList = () => {
    ...
    const courseColors = [
        ...
        { bg: 'linear-gradient(135deg, #4facfe, #00f2fe)', icon: '✍️' },
        ...
        <div>
            <div style={{ marginBottom: '2rem' }}>
                ...
                <p style={{ color: '#6B7280', fontSize: '0.95rem' }}>
                    Select a course to manage student exam papers and marks
                </p>
            </div>
                ...
                {myCourses.map((alloc, index) => {
                    ...
                    return (
                        <div
                            ...
                            onClick={() => navigate(`/staff/exam/${alloc.course_id}/students`)}
                        >
                            ...
                            <div className="course-info">
                                ...
                                <div className="course-progress">
                                    ...
                                    <div className="progress-text">Click to manage exams</div>
                                </div>
                            </div>
                        </div>
                    );
